<section class="popular-courses" style="width: 100%; ">
                            
                  <div class="specilization_word"><h1>POPULAR COURSES</h1></div>

<?php 

                  $obj_courses = new coursesApi();
                  $asc_courses = $conn->prepare("SELECT * FROM course WHERE type=0 ORDER BY popC DESC");
                  $asc_courses->execute();
